...
# 加載訓練數據集
train_dataset = ToothDataset(csv_file="../data/train_annotations_caries.csv",
...
# 加載驗證數據集
val_dataset = ToothDataset(csv_file="../data/test_annotations_caries.csv",
                           root_dir="../data/test_single_tooth", transform=base_transform)
...
# 讀取 CSV 文件
data = pd.read_csv("../data/train_annotations_caries.csv")
...
writer = SummaryWriter(
    "runs/resnet50_bbox_caries_unfreeze2_layers")

# 初始化變數來跟踪最佳驗證準確率
best_val_accuracy = 0.0
best_model_path = "../models/resnet50_bbox_caries_unfreeze2_layers"  # 保存最佳模型的路徑
# 訓練過程
epochs = 150
